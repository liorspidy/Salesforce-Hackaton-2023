...
module.exports.render = function (context) {
    ...
    if (cat) {
        ...
        catObj.imageURL = cat.custom.slotBannerImage ? cat.custom.slotBannerImage.getURL().toString() : null;
    ...
    return new Template('experience/components/maytronics_custom/middleBanner').render(model).text;
};