...
BMUtils._initSiteExportPage = function () {
  ...
  if (typeof BMUtils.siteIDs == "undefined") {
    ...
    var regExp = new RegExp(
      'id: "SiteContentExport_([A-Za-z0-9-_]*[A-Za-z0-9])"',
      "g"
    );
    ...
    var regExp = new RegExp(
      'id: "FullCatalogExport_([A-Za-z0-9-_]*[A-Za-z0-9])"',
      "g"
    );
    while ((match = regExp.exec(response))) {
...
BMUtils._initLocalesPage = function () {
  ...
  if (typeof BMUtils.locales == "undefined") {
    ...
    // do a synchronous "a"jax call to allow access without callback function
    var request = new Ajax.Request(
      "/on/demandware.store/Sites-Site/default/ViewLocales-Show",
      {
        method: "get",
        asynchronous: false,
        onSuccess: function (transport) {
...
BMUtils._initSitesPage = function () {
  ...
  if (typeof BMUtils.siteChannelIDs == "undefined") {
    ...
    // do a synchronous "a"jax call to allow access without callback function
    var request = new Ajax.Request(
      "/on/demandware.store/Sites-Site/default/ViewChannelList-ListAll?SelectedMenuItem=sites&CurrentMenuItemId=sites",
      {
        method: "get",
        asynchronous: false,
        onSuccess: function (transport) {
    ...
    // build regexp to match site ids
    var regExp = new RegExp(
      'ViewChannel-Edit\\?RepositoryUUID=([A-Za-z0-9]*)".*>([A-Za-z0-9-_ ]*)</a>.*\n.*width="50%".*>([A-Za-z0-9-_]*)&nbsp;<',
      "g"
    );
