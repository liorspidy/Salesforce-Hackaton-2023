...
(() => {
  ...
  function toggleColorPanelVisibility() {
    rootEditorElement
      .querySelector(".slds-color-picker__selector")
      .classList.toggle("slds-hide");
    rootEditorElement
      .querySelector(".slds-color-picker__selector")
      .classList.toggle("slds-show");
  }
  ...
  function hueHandler(event) {
    ...
    ).style.background = `hsl(${event.currentTarget.value}, 100%, 50%)`;
  ...
  function updateCustomUI(updatedObject) {
    ...
    rootEditorElement.querySelector(
      "#color-picker-custom .slds-swatch"
  ...
  listen(
    ...
    async ({
      ...
      rootEditorElement
        .querySelector(".slds-color-picker__summary-button")
        .addEventListener("click", toggleColorPanelVisibility);
      rootEditorElement
        .querySelector(".colorpicker-custom-tab")
      ...
      rootEditorElement
        .querySelector(".colorpicker-default-tab")
        .addEventListener("click", () =>
          switchElementsVisibility(
            "#color-picker-custom",
            "#color-picker-default"
      ...
      rootEditorElement
        .querySelectorAll(".slds-tabs_default__item")
        .forEach((tab) =>
      ...
      rootEditorElement
        ...
        .addEventListener("click", () => {
          var selectedColor = rootEditorElement.querySelector(
            "#color-picker-input-hex-9"
          ).value;
          rootEditorElement.querySelector("#color-picker-summary-input").value =
            selectedColor;
          rootEditorElement
            .querySelector("#color-picker-summary-input")
            .dispatchEvent(new Event("change"));
          toggleColorPanelVisibility();
        });

      rootEditorElement
        .querySelector(".slds-color-picker__custom-range")
        .addEventListener("dragover", satLumHandler);
      rootEditorElement
        .querySelector(".slds-color-picker__custom-range")
        .addEventListener("drop", satLumHandler);
      rootEditorElement
        .querySelector(".slds-color-picker__custom-range")
        .addEventListener("click", satLumHandler);
      rootEditorElement
        .querySelector("#color-picker-input-range-9")
        .addEventListener("input", hueHandler);

      rootEditorElement
        .querySelectorAll(".slds-color-picker__swatch-trigger")
        .forEach(function (element) {
          element.addEventListener("click", function (event) {
            event.preventDefault();
            var selectedColor = event.target.querySelector(
              ".slds-assistive-text"
            ).innerHTML;
            rootEditorElement.querySelector(
              "#color-picker-summary-input"
            ).value = selectedColor;
            rootEditorElement
              .querySelector("#color-picker-summary-input")
              .dispatchEvent(new Event("change"));
